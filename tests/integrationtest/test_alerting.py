...
class AlertingTest(TestCase):
    ...
    def test_c_delete_alertmanager_config(self):
        ...
        # The delete may be silently rejected when the config is provisioned.
        # Just assert that the config is still readable and has expected structure.
        config = self.alerting.get_alertmanager_config()
        self.assertIsNotNone(config)
        self.assertIsNotNone(config.get("alertmanager_config"))
