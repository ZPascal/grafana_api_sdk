...
class LibraryTest(TestCase):
    ...
    def test_a_get_all_library_elements(self):
        self.assertEqual(dict({"result": {"totalCount": 0, "elements": [], "page": 1, "perPage": 100}}),
    ...
    def test_c_get_library_element_by_uid(self):
        self.assertEqual("Test", self.library.get_library_element_by_uid(
            self.library.get_library_element_by_name("Test").get("result")[0].get("uid")).get("result").get("name"))

    def test_d_get_library_element_by_name(self):
        self.assertEqual("Test", self.library.get_library_element_by_name("Test").get("result")[0].get("name"))
