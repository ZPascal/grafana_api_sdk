...
class OrganisationTest(TestCase):
    ...
    def test_get_all_users_by_the_current_organization(self):
        organisation_users: list = self.organisation.get_all_users_by_the_current_organization()
    ...
    def test_a_update_current_organization(self):
        ...
        self.assertEqual("Test", self.organisation.get_current_organization().get("name"))

    def test_b_update_current_organization(self):
        self.organisation.update_current_organization("Github")
        self.assertEqual("Github", self.organisation.get_current_organization().get("name"))

    def test_a_add_new_user_to_current_organization(self):
        self.organisation.add_new_user_to_current_organization("info@theiotstudio.com", "Viewer")
