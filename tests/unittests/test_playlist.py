...
class PlaylistTestCase(TestCase):
    ...
    def test_search_playlist(self, call_the_api_mock):
        ...
        self.assertEqual([{"uid": "test"}], playlist.search_playlist())
    ...
    def test_get_playlist(self, call_the_api_mock):
        ...
        self.assertEqual({"uid": "test"}, playlist.get_playlist("test"))
    ...
    def test_get_playlist_items(self, call_the_api_mock):
        ...
        call_the_api_mock.return_value = [{"uid": "test", "value": "test"}]
    ...
    def test_create_playlist(self, call_the_api_mock):
        ...
        self.assertEqual(
            {"uid": "test"}, playlist.create_playlist(playlist_object)
        )
    ...
    def test_update_playlist(self, call_the_api_mock):
        ...
        self.assertEqual(
            {"uid": "test"}, playlist.update_playlist("test", playlist_object)
        )
