...
from src.grafana_api.model import APIModel, UserObject
from src.grafana_api.user import User, CurrentUser
...
class UserTestCase(TestCase):
    ...
    def test_update_user(self, call_the_api_mock):
        ...
        mock: Mock = Mock()
        mock.json = Mock(return_value=dict({"message": "User updated"}))
    ...
    def test_get_user_organizations(self, call_the_api_mock):
        ...
        mock: Mock = Mock()
        mock.json = Mock(return_value=list([{"orgId": 1}]))
    ...
    def test_switch_specific_user_context(self, call_the_api_mock):
        ...
        mock: Mock = Mock()
        mock.json = Mock(return_value=dict({"message": "Active organization changed"}))
...
class CurrentUserTestCase(TestCase):
    ...
    def test_update_password(self, call_the_api_mock):
        ...
        mock: Mock = Mock()
        mock.json = Mock(return_value=dict({"message": "User password changed"}))
    ...
    def test_star_a_dashboard(self, call_the_api_mock):
        ...
        mock: Mock = Mock()
        mock.json = Mock(return_value=dict({"message": "Dashboard starred!"}))
    ...
    def test_unstar_a_dashboard(self, call_the_api_mock):
        ...
        mock: Mock = Mock()
        mock.json = Mock(return_value=dict({"message": "Dashboard unstarred"}))
