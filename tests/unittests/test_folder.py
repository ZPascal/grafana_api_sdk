...
class FolderTestCase(TestCase):
    ...
    def test_get_folder_by_uid(self, call_the_api_mock):
        ...
        self.assertEqual(dict({"title": None, "id": 12}), folder.get_folder_by_uid("xty13y"))
    ...
    def test_create_folder(self, call_the_api_mock):
        ...
        call_the_api_mock.return_value = dict({"title": None, "id": 12})
        self.assertEqual(dict({"title": None, "id": 12}), folder.create_folder("test", "test"))
    ...
    def test_update_folder(self, call_the_api_mock):
        ...
        call_the_api_mock.return_value = dict({"title": None, "id": 12})
        self.assertEqual(dict({"title": None, "id": 12}), folder.update_folder("test", "test", 10))
    ...
    def test_update_folder_overwrite_true(self, call_the_api_mock):
        ...
        call_the_api_mock.return_value = dict({"title": None, "id": 12})
        self.assertEqual(dict({"title": None, "id": 12}), folder.update_folder("test", "test", overwrite=True))
    ...
    def test_update_folder_permissions(self, call_the_api_mock):
        ...
        self.assertEqual(None, folder.update_folder_permissions("test", dict({"test": "test"})))
    ...
    def test_get_folder_id_by_dashboard_path_no_title_match(
        ...
        all_folder_ids_and_names_mock.return_value = list([{"title": "test", "id": "xty13y"}])
        with self.assertRaises(Exception):
