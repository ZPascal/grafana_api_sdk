...
class OrganisationTestCase(TestCase):
    ...
    def test_get_current_organization(self, call_the_api_mock):
        ...
        self.assertEqual({"id": 1}, self.organisation.get_current_organization())
    ...
    def test_update_organization_user_role_by_user_id(self, call_the_api_mock):
        call_the_api_mock.return_value = {"message": "Organization user updated"}
    ...
    def test_delete_organization_user_by_user_id(self, call_the_api_mock):
        call_the_api_mock.return_value = {"message": "User removed from organization"}
    ...
    def test_update_current_organization(self, call_the_api_mock):
        call_the_api_mock.return_value = {"message": "Organization updated"}
    ...
    def test_add_new_user_to_current_organization(self, call_the_api_mock):
        call_the_api_mock.return_value = {"message": "User added to organization", "userId": 1}
...
class OrganisationAdminTestCase(TestCase):
    ...
    def test_get_organization_by_id(self, call_the_api_mock):
        call_the_api_mock.return_value = {"id": 10}

        self.assertEqual({"id": 10}, self.organisation.get_organization_by_id(1))
    ...
    def test_get_organization_by_name(self, call_the_api_mock):
        ...
        self.assertEqual(
            {"id": 10}, self.organisation.get_organization_by_name("test")
        )
    ...
    def test_get_organizations(self, call_the_api_mock):
        ...
        self.assertEqual([{"id": 1}], self.organisation.get_organizations())
    ...
    def test_create_organization(self, call_the_api_mock):
        call_the_api_mock.return_value = {"message": "Organization created", "orgId": 10}
    ...
    def test_delete_organization(self, call_the_api_mock):
        call_the_api_mock.return_value = {"message": "Organization deleted"}
    ...
    def test_get_organization_users(self, call_the_api_mock):
        call_the_api_mock.return_value = [{"orgId": 1, "userId": 10}]
    ...
    def test_add_organization_user(self, call_the_api_mock):
        call_the_api_mock.return_value = {"message": "User added to organization", "userId": 10}
