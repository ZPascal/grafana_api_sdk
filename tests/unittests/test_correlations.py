...
class CorrelationsTestCase(TestCase):
    ...
    def test_get_correlation(self, call_the_api_mock):
        ...
        call_the_api_mock.return_value = {"description": "test"}
    ...
    @patch("grafana_api.api.Api.call_the_api")
    def test_get_all_correlations_dict_result(self, call_the_api_mock):
        model: APIModel = APIModel(host=MagicMock(), token=MagicMock())
        correlations: Correlations = Correlations(grafana_api_model=model)

        call_the_api_mock.return_value = {"correlations": [{"description": "test"}]}
    ...
    @patch("grafana_api.api.Api.call_the_api")
    def test_get_all_correlations_not_possible_no_dict(self, call_the_api_mock):
        model: APIModel = APIModel(host=MagicMock(), token=MagicMock())
        correlations: Correlations = Correlations(grafana_api_model=model)
    ...
    def test_delete_correlations(self, call_the_api_mock):
        ...
        call_the_api_mock.return_value = {"message": "Correlation deleted"}
